...
# Plot polarity vs. (term reordered by polarity), filled by pos_or_neg
 ggplot(data_tidy_pol, aes(reorder(words, Polarity), Polarity, fill = Sentiment)) +
  geom_col() + 
...
ggsave("polarity_chart.png", plot=last_plot())

```

```{r Most common pos and neg words}
